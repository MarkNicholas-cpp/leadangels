...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center flex-col py-20 md:py-10">
            ...
            <div className="w-full p-6 bg-gray-50 rounded-lg shadow md:mt-0 sm:max-w-md sm:p-8">
              ...
              >
                ...
                >
                  ...
                  >
                    <path
                      d="M19.6 10.23c0-.64-.06-1.25-.16-1.83H10v3.46h5.5a4.71 4.71 0 0 1-2.04 3.1v2.58h3.3c1.93-1.78 3.04-4.41 3.04-7.31z"
                      fill="#4285F4"
                    />
                    <path
                      d="M13.46 14.96a5.3 5.3 0 0 1-3.46 1.24c-2.65 0-4.89-1.79-5.69-4.19H1v2.65a9.93 9.93 0 0 0 5.46 3.09v-2.58z"
                      fill="#34A853"
                    />
                    <path
                      d="M3.92 10c-.12-.37-.19-.76-.19-1.17 0-.41.07-.8.19-1.17V5.01H1A9.93 9.93 0 0 0 .04 10c0 1.6.38 3.11 1.04 4.45l2.84-2.45z"
                      fill="#FBBC05"
                    />
                    <path
                      d="M10 3.95c1.45 0 2.75.5 3.78 1.49l2.84-2.45C14.89 1.58 12.65 0 10 0 6.54 0 3.56 2.13 2.3 5.01l2.84 2.45A5.77 5.77 0 0 1 10 3.95z"
                      fill="#EA4335"
                    />
                  </svg>
