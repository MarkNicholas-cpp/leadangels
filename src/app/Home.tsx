  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-10">
          <p className="text-lg mb-16" ref={eleref}>
        ...
        <div className="menu-bar px-10 py-5 grid grid-cols-1 md:grid-cols-2 gap-10 border-t border-b border-gray-200 ">
          <div className="menu-card">
            ...
            <div className="flex items-center justify-center p-3 bg-gray-200">
              <Image
                src="/src/assets/svgs/ActiveInvestors.svg"
                alt="Active Investors"
                width={64}
                height={64}
              />
            </div>
          ...
          <div className="menu-card">
            ...
            <div className="flex items-center justify-center p-3 bg-gray-200">
              <Image
                src="/src/assets/svgs/EngageInvestors.svg"
                alt="Engage Investors"
                width={64}
                height={64}
              />
            </div>
          ...
          <div className="menu-card">
            ...
            <div className="flex items-center justify-center p-3 bg-gray-200">
              <Image
                src="/src/assets/svgs/SeamlessOnboarding.svg"
          ...
          <div className="menu-card">
            ...
            <div className="flex items-center justify-center p-3 bg-gray-200">
              <Image
                src="/src/assets/svgs/OptimizePortfolio.svg"
                alt="Optimize Portfolio"
                width={64}
                height={64}
              />
            </div>
          ...
          <div className="menu-card">
            ...
            <div className="flex items-center justify-center p-3 bg-gray-200">
              <Image
                src="/src/assets/svgs/ManageEquity.svg"
                alt="Manage Equity"
                width={64}
                height={64}
              />
